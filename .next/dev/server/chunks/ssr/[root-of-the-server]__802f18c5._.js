...
function ProductsPage() {
    ...
    const fetchProducts = async ()=>{
        setLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`/products?search=${searchTerm}`);
    ...
    const handleDelete = async (id)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`/products/${id}`);
            const deleted = products.find((p)=>p.id === id);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notifications$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logBackup"])("Product", "Deleted", deleted?.name || "Unknown", deleted, null);
            fetchProducts();
        } catch (error) {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            if (currentProduct) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`/products/${currentProduct.id}`, productData);
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notifications$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logBackup"])("Product", "Modified", formData.name, currentProduct, productData);
            } else {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/products", productData);
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notifications$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logBackup"])("Product", "Added", formData.name, null, productData);
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__802f18c5._.js.map